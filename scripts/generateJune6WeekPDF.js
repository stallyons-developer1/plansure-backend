...
const generatePDF = () => {
  ...
  const activities = [
    {
      id: "JUN6-PROG",
      name: "June 6-Week Construction Programme",
      duration: 42,
      start: new Date(2026, 5, 1),
      finish: new Date(2026, 6, 12),
      isHeader: true,
    },
  ...
  doc
    .fontSize(14)
    .font("Helvetica-Bold")
    .text("June Construction Project / 2026 (6-Week Cycle)", 50, 30);
  ...
  doc
    ...
    .font("Helvetica")
    .text(
      "Generated by PlanSure | Test Programme (6-week cycle from 01-Jun-2026)",
      50,
      tableBottom + 15,
    );
