...
const generateTestPDF = () => {
  ...
  const outputPath =
    "/Users/apple/Desktop/Plansure PDF/test_programme_june_2026.pdf";
  ...
  const activities = [
    ...
    },
    {
      ...
      duration: 8,
      start: new Date(2026, 4, 30),
      finish: new Date(2026, 5, 8),
      status: "blocked",
    },
    {
      id: "JUN-007",
